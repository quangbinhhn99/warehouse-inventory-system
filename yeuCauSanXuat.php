  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        ...
        <div class="pull-left"><h3>Yêu cầu sản xuất</h3></div>
        ...
        <div class="panel-body">
          <table class="table table-bordered" id="request">
            ...
            <tbody>
              <?php $i=1; foreach ($request as $data):?>
              <tr>
              <?php $product = find_by_id('products', $data['idPro']) ?>
                ...
                <td class="text-center"> <?php if($data['status']==0) echo 'Đã tiếp nhận';
                                                ...
                                                else if($data['status'==2]) echo "Đã hoàn thành"; ?></td>
                <td class="text-center"> <?php echo remove_junk($data['note']); ?></td>
                <td class="text-center">
             <div class="btn-group">
                <a href="chiTietKeHoachVatTu.php?id=<?php echo (int)$a_vattu['id'];?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="detail">
           ...
           <td class="text-center">
             <div class="btn-group">
                <a href="edit_vattu.php?id=<?php echo (int)$a_vattu['id'];?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="detail">
                  <i class="glyphicon glyphicon-pencil"></i>
               </a>
