<?php
  ...
  $all_groups = find_all('vattu_groups');
?>
      ...
      <table class="table table-bordered">
        ...
        <?php foreach($all_groups as $a_group): ?>
          <tr>
           ...
           <td><?php echo remove_junk(ucwords($a_group['group_vattu']))?></td>
           <td class="text-center">
             <?php echo remove_junk(ucwords($a_group['group_level']))?>
           </td>
           <td class="text-center">
             <div class="btn-group">
                <a href="edit_vattu_group.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
